        ...
        <section className="py-6 bg-secondary/30">
          <div className="container-wide">
            ...
            >
              ...
              <h1 className="text-2xl md:text-3xl font-jakarta font-semibold">About Xen</h1>
            </motion.div>
          </div>
        </section>
          ...
          <div className="container-wide">
            <div className="grid md:grid-cols-2 gap-8">
              ...
              >
                ...
                <h3 className="text-2xl font-jakarta font-semibold mb-4">Our Mission</h3>
                <p className="text-muted-foreground">
              ...
              >
                ...
                <h3 className="text-2xl font-jakarta font-semibold mb-4">Our Vision</h3>
                <p className="text-muted-foreground">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {values.map((value, index) => (
                ...
                >
                  ...
                  <h3 className="text-lg font-jakarta font-semibold mb-2">{value.title}</h3>
