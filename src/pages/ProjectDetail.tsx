          ...
          <div className="absolute bottom-0 left-0 right-0">
            <div className="container-wide pb-8">
              ...
              >
                ...
                <h1 className="text-3xl md:text-4xl lg:text-5xl font-cormorant font-semibold text-white drop-shadow-lg">
                  {project.name}
                </h1>
              </motion.div>
            </div>
          ...
          <div className="container-wide">
            <div className="grid lg:grid-cols-3 gap-12">
              ...
              <div className="lg:col-span-2">
                ...
                >
                  <h2 className="text-2xl font-cormorant font-semibold mb-4">About This Project</h2>
                  <p className="body-large text-muted-foreground mb-6">
                    {project.fullDescription}
                  </p>

                  {/* Features */}
                  <h3 className="text-xl font-cormorant font-semibold mb-4 mt-8">Key Features</h3>
                  ...
                  {/* Amenities */}
                  <h3 className="text-xl font-cormorant font-semibold mb-4 mt-8">Amenities</h3>
                  <div className="grid sm:grid-cols-2 gap-3">
              ...
              <div className="lg:col-span-1">
                ...
                >
                  <h3 className="text-lg font-cormorant font-semibold mb-4">Project Details</h3>
