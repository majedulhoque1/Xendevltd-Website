      ...
      >
        ...
        <div className="grid grid-rows-[auto_auto_auto] items-start text-left">
          <motion.p
            ...
            className="hero-eyebrow font-jakarta text-white/90 text-xs uppercase tracking-widest mb-4 inline-flex w-fit max-w-fit items-center gap-2 self-start px-3 py-1.5 rounded-full bg-white/10 backdrop-blur-md border border-white/25 whitespace-nowrap"
          >
          ...
          <h1
            className="hero-h1 font-jakarta text-white uppercase leading-tight text-[97px]"
        ...
        <div className="flex flex-col justify-center items-end text-right">
          <h2 className="hero-h2 font-jakarta uppercase text-white leading-tight font-bold" style={{ fontSize: "36px" }}>
            <motion.span
              className="block"
              initial={{ opacity: 0, y: 40 }}
              animate={{ opacity: 1, y: 0 }}
