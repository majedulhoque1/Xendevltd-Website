  ...
  return (
    <section className="relative min-h-screen flex">
      ...
      <motion.div
        ...
        className="w-full lg:w-[42%] bg-background flex flex-col justify-center px-8 md:px-12 lg:px-16 py-24 lg:py-16 relative z-10"
      >
      ...
      {/* Middle Vertical Navigation - Desktop Only */}
      <motion.div
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.6, delay: 0.4 }}
        className="hidden lg:flex flex-col items-center justify-center w-20 bg-secondary/80 backdrop-blur-sm border-x border-border relative z-10"
      >
        <nav className="flex flex-col items-center gap-8">
          {navItems.map((item, index) => (
            <motion.a
              ...
              className="text-xs font-medium tracking-widest uppercase text-muted-foreground hover:text-primary transition-colors writing-vertical"
